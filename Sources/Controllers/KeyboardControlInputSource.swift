...
*/
// Hacemos implementacion en ios y macos porque el ipad es posible jugar con teclado como mac e incluso un iphone podria tener teclado auqneu no lo utilice la gente.
